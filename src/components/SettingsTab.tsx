    ...
    <div className="page-transition">
          ...
          <div style={{ background: '#fff', border: '1px solid var(--border-medium)', borderRadius: '18px', overflow: 'hidden', boxShadow: '0 4px 12px rgba(0,0,0,0.01)', display: 'flex', flexDirection: 'column' }}>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                ...
                <div>
                  <span style={{ fontSize: '17px', fontWeight: '700', color: 'var(--text-primary)', display: 'block' }}>보관위치 관리</span>
                  <span style={{ fontSize: '14px', color: 'var(--text-secondary)', marginTop: '2px', display: 'block' }}>공간, 수납처, 칸/서랍 추가 및 일괄 삭제</span>
                </div>
              </div>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                ...
                <div>
                  <span style={{ fontSize: '17px', fontWeight: '700', color: 'var(--text-primary)', display: 'block' }}>가족 동기화</span>
                  <span style={{ fontSize: '14px', color: 'var(--text-secondary)', marginTop: '2px', display: 'block' }}>기기 동기화 및 가족 공유 연동 설정</span>
                </div>
              </div>
              <ChevronRight size={18} color="var(--text-tertiary)" />
            </div>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                ...
                <div>
                  <span style={{ fontSize: '17px', fontWeight: '700', color: 'var(--text-primary)', display: 'block' }}>유통기한 알림 설정</span>
                  <span style={{ fontSize: '14px', color: 'var(--text-secondary)', marginTop: '2px', display: 'block' }}>유통기한 미리알림 기준일 설정</span>
                </div>
              </div>
              <ChevronRight size={18} color="var(--text-tertiary)" />
            </div>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                ...
                <div>
                  <span style={{ fontSize: '17px', fontWeight: '700', color: 'var(--text-primary)', display: 'block' }}>애플리케이션 초기화</span>
                  <span style={{ fontSize: '14px', color: 'var(--text-secondary)', marginTop: '2px', display: 'block' }}>공장 초기화 및 앱 버전 정보</span>
                </div>
              </div>
              <ChevronRight size={18} color="var(--text-tertiary)" />
            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div style={{ background: '#fff', border: '1px solid var(--border-medium)', borderRadius: '18px', padding: '20px', display: 'flex', flexDirection: 'column', gap: '20px', boxShadow: '0 4px 12px rgba(0,0,0,0.01)' }}>
              <div style={{
                ...
                {showSyncGuide && (
                  <div style={{
                    borderTop: '1px dashed rgba(49, 130, 246, 0.2)',
                    paddingTop: '12px',
                    display: 'flex',
                    flexDirection: 'column',
                    gap: '12px',
              ...
              <div style={{ borderTop: '1px dashed var(--border-subtle)', paddingTop: '8px' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                              ...
                              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                {isCurrent ? (
                                  ...
                                  <button
                                    ...
                                    style={{ border: '1px solid var(--border-medium)', background: '#fff', color: 'var(--text-secondary)', padding: '6px 12px', borderRadius: '12px', fontSize: '14px', fontWeight: '700', cursor: 'pointer', transition: 'background var(--transition-fast)' }}
                                    onMouseEnter={(e) => e.currentTarget.style.background = 'var(--bg-subtle)'}
                    ...
                    {(() => {
                      ...
                      return (
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                          ...
                          <div style={{ background: '#f8f9fa', padding: '14px 16px', borderRadius: '14px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', border: '1px solid var(--border-medium)' }}>
                            <strong style={{ fontSize: '16px', color: 'var(--text-primary)', fontWeight: '700', letterSpacing: '0.5px' }}>
                              {myOwnerGroupCode}
                            </strong>
                                  ...
                                  if (myOwnerGroupCode) {
                                    ...
                                    if (isTossInApp) {
                                      try {
                                        ...
                                        console.warn('Toss share native modal failed:', shareErr);
                                        if (typeof navigator !== 'undefined' && navigator.clipboard) {
                                          await navigator.clipboard.writeText(shareText);
                                          alert('초대 메시지 문구가 복사되었습니다! 카카오톡 등 대화방에 붙여넣어 공유해 보세요.');
                                        }
                                      }
                                    } else {
                    ...
                    <div style={{ borderTop: '1px dashed var(--border-subtle)', paddingTop: '20px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                      <span style={{ fontSize: '14px', fontWeight: '700', color: 'var(--text-primary)' }}>새로운 공유 보관소 참여하기</span>
                      
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        <span style={{ fontSize: '12px', fontWeight: '600', color: 'var(--text-secondary)' }}>공유 코드</span>
                      ...
                      <span style={{ fontSize: '12px', color: 'var(--text-tertiary)', marginTop: '-4px', display: 'block', lineHeight: '1.4' }}>
                        * 현재 보관소에 설정된 내 호칭(<strong>"{myNickname || '소유자'}"</strong>)으로 가입 신청이 전송됩니다.
                      </span>
                      
                      {syncError && (
                        <div style={{ display: 'flex', alignItems: 'center', gap: '6px', background: '#fff2f2', border: '1px solid #ffd1d1', padding: '10px', borderRadius: '10px', color: 'var(--accent-red)', fontSize: '12px' }}>
      ...
      {subPage === 'expiration' && (
        <div>
          ...
          <div style={{ background: '#fff', border: '1px solid var(--border-medium)', borderRadius: '18px', padding: '20px', display: 'flex', flexDirection: 'column', gap: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.01)' }}>
            <div>
              <span style={{ display: 'block', fontSize: '14px', fontWeight: '700', color: 'var(--text-tertiary)', letterSpacing: '0.5px', marginBottom: '8px' }}>
                알림 기간 수정
              </span>
              <span style={{ fontSize: '17px', fontWeight: '700', color: 'var(--text-primary)', display: 'block', marginBottom: '4px' }}>
                유통기한 미리알림 기간
              </span>
              <span style={{ fontSize: '14px', color: 'var(--text-secondary)', display: 'block', marginBottom: '12px', lineHeight: '1.4' }}>
        ...
        <div>
          ...
          <div style={{ background: '#fff', border: '1px solid var(--border-medium)', borderRadius: '18px', padding: '24px 20px', display: 'flex', flexDirection: 'column', gap: '20px', boxShadow: '0 4px 12px rgba(0,0,0,0.01)' }}>
            <div>
              ...
              <span style={{ fontSize: '17px', fontWeight: '700', color: 'var(--text-primary)', display: 'block', marginBottom: '8px' }}>
                공장 초기화 진행
              </span>
              <span style={{ fontSize: '14px', color: 'var(--text-secondary)', display: 'block', lineHeight: '1.5' }}>
          ...
          <div style={{ marginTop: '24px', textAlign: 'center' }}>
            <span style={{ fontSize: '14px', color: 'var(--text-tertiary)', fontWeight: '600', opacity: 0.8 }}>
              where is it . {import.meta.env.VITE_APP_VERSION || 'v00137'}
            </span>
          </div>
        </div>
      )}
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: (innerStorages.length > 0 && expandedSpaces[s.id]) ? '1px dashed var(--border-subtle)' : 'none', paddingBottom: (innerStorages.length > 0 && expandedSpaces[s.id]) ? '12px' : '0' }}>
                      ...
                      >
                        ...
                        <span style={{ fontSize: '17px', fontWeight: '700', color: 'var(--text-primary)' }}>
                          {s.name} 
                          <span style={{ fontSize: '12px', color: 'var(--text-tertiary)', marginLeft: '4px' }}>(공간)</span>
                          {innerStorages.length > 0 && !expandedSpaces[s.id] && (
                            <span style={{ fontSize: '12px', color: 'var(--toss-blue)', marginLeft: '8px', fontWeight: '600', background: 'var(--toss-blue-light)', padding: '2px 6px', borderRadius: '8px' }}>
                              ...
                              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: (innerSections.length > 0 && expandedStorages[st.id]) ? '1px solid var(--border-medium)' : 'none', paddingBottom: (innerSections.length > 0 && expandedStorages[st.id]) ? '8px' : '0' }}>
                                ...
                                >
                                  ...
                                  <span style={{ fontSize: '14px', fontWeight: '700', color: 'var(--text-secondary)' }}>
                                    {st.name} 
                                    <span style={{ fontSize: '11px', color: 'var(--text-tertiary)' }}>(수납처)</span>
                                    {innerSections.length > 0 && !expandedStorages[st.id] && (
                                      <span style={{ fontSize: '11px', color: '#2e7d32', marginLeft: '6px', fontWeight: '600', background: '#e8f5e9', padding: '1px 5px', borderRadius: '6px' }}>
                                  ...
                                  {innerSections.map(se => (
                                    ...
                                    >
                                      <div style={{ display: 'flex', alignItems: 'center', gap: '6px', minWidth: 0, flex: 1 }}>
                                        ...
                                        <span style={{ fontSize: '14px', fontWeight: '500', color: 'var(--text-secondary)', textOverflow: 'ellipsis', overflow: 'hidden', whiteSpace: 'nowrap' }}>
                                          {se.name}
                                        </span>
                                      </div>
                                      <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                ...
                {spaces.length > 0 && (
                  <div style={{ background: 'var(--bg-subtle)', padding: '12px 16px', borderRadius: '12px', border: '1px solid var(--border-medium)', marginTop: '8px' }}>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
                      {spaces.map(s => (
                        <span key={s.id} style={{ fontSize: '14px', background: '#fff', border: '1px solid var(--border-medium)', padding: '4px 8px', borderRadius: '8px', color: 'var(--text-secondary)', display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
            ...
            {locationType === 'storage' && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div className="form-group" style={{ marginBottom: 0 }}>
                  ...
                  {spaces.length === 0 ? (
                    <div style={{ fontSize: '14px', color: 'var(--text-tertiary)', padding: '8px 4px' }}>등록된 공간이 없습니다. 1단계 공간을 먼저 생성하세요.</div>
                  ) : (
            ...
            {locationType === 'section' && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div className="form-group" style={{ marginBottom: 0 }}>
                  ...
                  {spaces.length === 0 ? (
                    <div style={{ fontSize: '14px', color: 'var(--text-tertiary)', padding: '8px 4px' }}>등록된 공간이 없습니다.</div>
                  ) : (
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginTop: '4px' }}>
                      {spaces.map(s => {
                ...
                <div className="form-group" style={{ marginBottom: 0 }}>
                  ...
                  {!locSelectedStorageSpaceId ? (
                    <div style={{ fontSize: '14px', color: 'var(--text-tertiary)', padding: '8px 4px' }}>먼저 공간을 선택해 주세요.</div>
                  ) : availableStoragesForSectionLoc.length === 0 ? (
                    <div style={{ fontSize: '14px', color: 'var(--text-tertiary)', padding: '8px 4px' }}>이 공간에 등록된 수납처가 없습니다.</div>
                  ) : (
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginTop: '4px' }}>
                        ...
                        <div style={{ background: 'var(--bg-subtle)', padding: '12px 16px', borderRadius: '12px', border: '1px solid var(--border-medium)', marginTop: '8px' }}>
                          ...
                          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
                            {existingSections.map(se => (
                              <span key={se.id} style={{ fontSize: '14px', background: '#fff', border: '1px solid var(--border-medium)', padding: '4px 8px', borderRadius: '8px', color: 'var(--text-secondary)', display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
                                {se.image_url ? (
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div style={{
            ...
            <span style={{ fontSize: '14px', color: 'var(--text-secondary)', fontWeight: '700' }}>현재 선택됨</span>
          </div>
      ...
      >
        <form onSubmit={handleSaveLocationEdit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          {editLocType === 'storage' && (
            <div className="form-group" style={{ marginBottom: 0 }}>
              <label className="form-label" style={{ fontSize: '14px' }}>수납처 사진 등록/변경</label>
              <input 
